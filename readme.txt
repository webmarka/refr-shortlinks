...
Creates a custom short URL when saving posts. Requires your own REFR install.
...
REFR is a self-hosted PHP based application that allows you to make your own custom shortlinks, similar to bit.ly and j.mp. [Learn more about it here](http://yourls.org/ "REFR download")
...
1. Metabox to create REFR link with optional keyword field
